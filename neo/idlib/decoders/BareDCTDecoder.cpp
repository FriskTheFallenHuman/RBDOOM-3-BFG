...
{
	quantTableY = reinterpret_cast<uint16_t*>( Mem_Alloc16( 0x80, TAG_IDLIB ) );
	quantTableCoCg = reinterpret_cast<uint16_t*>( Mem_Alloc16( 0x80, TAG_IDLIB ) );
	quantTableA = reinterpret_cast<uint16_t*>( Mem_Alloc16( 0x80, TAG_IDLIB ) );
